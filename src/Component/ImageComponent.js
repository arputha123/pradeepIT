        ...
        <div class="container-fluid d-flex justify-content-center container" style={{ paddingTop: 60, paddingLeft: 50, paddingBottom: 40 }}>
            <div class="row ">
                <div class="col-lg-4 col-md-10 col-sm-10 col-xs-12">
                    ...
                    <h1 style={{ color: '#FDD947', textAlign: 'center',fontSize:60 ,transform:'rotate(180deg)'}}><b>,,</b></h1>
                </div>

                <div class="col-lg-4 col-md-10 col-sm-10 col-xs-12">
                    <img src={officeStaff} style={{ height: 130, width: 130, borderRadius: 65, marginLeft: '30%', marginBottom: 20 }} />
                ...
                <div class="col-lg-4 col-md-10  col-sm-10 col-xs-12">
                    <img src={Office3} style={{ height: 130, width: 130, borderRadius: 65, marginLeft: '30%', marginBottom: 20 }} />
