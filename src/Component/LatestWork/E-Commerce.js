...
import img from '../../Images/ecommerce-2607114_960_720.jpg'
import line from '../../Images/line2.png'
import fund from '../../Images/greenlaptop.png';
import Shopping from '../../Images/e-commerce.png';
  ...
  const [data, setData] = useState([
    {
      ...
      Heading: "WILL ECOMMERCE OVERCOME TOMORROWS RETAIL CHALLENGES…?",
      BodyData: "After discovering new way of supply chain into market and distribution of products to customers, which has made remarkable industry growth into so called retail and wholesale manufacturing industry. Today’s...",
      Likes: "277 LIKES"
    },
    {
      Img: fund,
      Admin: "POSTED BY ADMIN",
      Date: "FEBRUARY 24, 2016",
      Heading: "WILL HEADLESS ECOMMERCE OVERCOME TRADITIONAL ECOMMERCE",
      BodyData: "In the digital commerce revolution, the consumers are more likely to engage with brands that are unique and experience with irrespective to preferred business channel. The multiplexed experience is not...",
      Likes: "279 LIKES"
    },
    {
        Img: Shopping,
        Admin: "POSTED BY ADMIN",
        Date: "FEBRUARY 24, 2016",
        Heading: "VOICE BASED SHOPPING: NEXT GENERATION OF ECOMMERCE",
        BodyData: "In the technology revolution, the innovation has no limit in any filed where technology taking forward into next level. As earlier days in the last decade, the ecommerce where high...",
        Likes: "233 LIKES"
      }
  ])
        ...
        <div className="container col2-layout">
          <div style={{ paddingTop: 40, paddingLeft: 13, paddingRight: 13 }} className="row">
            ...
            <div className="col-lg-4 col-md-5 col-sm-12 breadcrumb text-uppercase wow fadeInUp xs-display-none animated">
              ...
              <p className="animate_content animated" style={{ fontWeight: "lighter", color: "gray", fontSize: "14px" }}> <a href="/" style={{ textDecoration: 'none', color: 'gray' }}>HOME</a> <span>|</span> ECOMMERCE</p>
            </div>
          </div>
        </div>
      </div>
