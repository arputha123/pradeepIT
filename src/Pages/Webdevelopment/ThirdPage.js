...
import '../../Pages/Webdevelopment/ThirdPage.css'
        ...
        <>
            <div style={{ width: "100%", height: "auto" }}>
                ...
                <div class="d-flex justify-content-center" style={{ marginBottom: 50 }}>
                    <h3 style={{ fontSize: "20px", fontWeight: 700, color: "#000000",letterSpacing:1 }}>CMS WEB DEVELOPMENT SERVICES</h3>
                </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                        <div class="d-flex justify-content-around align-items-center">
                            <div class="text-center">
                                ...
                                <div>
                                    <span class="e-commerce" style={{fontSize:11, letterSpacing: 2 ,color:picture ? "black": "#9A9A9A",fontWeight:picture ? 700:600}}>CMS DEVELOPMENT</span>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                        <div class="d-flex justify-content-around align-items-center">
                            <div class="text-center">
                                ...
                                <div>
                                    <span class="e-commerce" style={{fontSize:11, letterSpacing: 2,fontWeight:tool ? 700 : 600,color: tool ?"black":"#9A9A9A" }}>CREATIVE CONTENT</span>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                        <div class="d-flex justify-content-around align-items-center">
                            <div class="text-center">
                                ...
                                <div>
                                    <span class="e-commerce" style={{fontSize:11, letterSpacing: 2 ,color:mobile?"black": "#9A9A9A",fontWeight:mobile ? 700 : 600}}>CONTACT FORM</span>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                        <div class="d-flex justify-content-around align-items-center">
                            <div class="text-center">
                                ...
                                <div>
                                    <span class="e-commerce" style={{fontSize:11, letterSpacing: 2 ,color:camera?"black": "#9A9A9A" ,fontWeight:camera ? 700 : 600}}> CUSTOM PLUGIN DEVELOPMENT</span>
                                </div>
                            </div>
