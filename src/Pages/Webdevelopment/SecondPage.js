...
import '../../Pages/Webdevelopment/SecondPage.css';
    ...
    return (
        <div  style={{ width: "100%", height: "auto" }}>
            ...
            <div class="d-flex justify-content-center" style={{ paddingBottom: 40 }}>
                <h3 style={{ fontSize: 20, fontWeight: 700, backgroundColor: "", padding: "5px 5px",color:"black",letterSpacing:"0.02em" }}>WE WORKED WITH THESE BUSINESS</h3>
            </div>
            ...
            <div style={{ height: "auto", backgroundColor: "#E5E5E5", padding: "100px" }}>
                ...
                <div class="d-flex justify-content-center" >
                    <h4 style={{ fontSize: 20, paddingBottom: 100,fontWeight:700,color:"black",letterSpacing:"0.02em" }}>WHAT WE DO</h4>
                </div>
