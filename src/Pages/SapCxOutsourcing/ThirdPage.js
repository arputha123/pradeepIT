...
import '../../Pages/SapCxOutsourcing/ThirdPage.css'
        ...
        <>
            <div style={{ width: "100%", height: "auto" }}>
                ...
                <div class="d-flex justify-content-center" style={{ marginBottom: 50 }}>
                    <h3 style={{ fontSize: "20px", fontWeight: 700, color: "#000000" ,letterSpacing:"0.02em"}}>OUR SAP CX DEVELOPMENT EXPERTISE</h3>
                </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="d-block">
                                ...
                                <div>
                                    <span class="e-commerce" style={{fontSize:11, letterSpacing: 2 ,color:picture ? "black": "#9A9A9A",fontWeight: picture ?700:600}}>RETAIL & E - COMMERCE</span>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="d-block">
                                ...
                                <div>
                                    <span class="e-commerce" style={{fontSize:11, letterSpacing: 2,fontWeight:tool?700:600,color: tool ?"black":"#9A9A9A" }}>EDUCATION & E - LEARNING</span>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="d-block">
                                ...
                                <div>
                                    <span class="e-commerce" style={{fontSize:11, letterSpacing: 2 ,color:mobile?"black": "#9A9A9A",fontWeight:mobile?700:600}}>BANKING & FINANCE</span>
                                </div>
                            </div>
                    ...
                    {tool && <>
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12" style={{ paddingRight: "50px" }}>
                            <div style={{ height: "80vh", border: "5px solid #D7D7D7", padding: "30px 10px" }}>
                                ...
                                <div class="d-flex justify-content-center">
                                    <p class="" style={{ color: "#9A9A9A", fontSize: 14, margin: "30px auto", textAlign: "center", width: "60%" }}>Think beyond traditional LMS & enter the modern era with our Java Development Services</p>
                                </div>
                    ...
                    {mobile && <>
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                            <div style={{ height: "80vh", backgroundColor: "#666666", paddingTop: "350px", paddingBottom: "50px" }}>
                                ...
                                <div class="d-flex justify-content-center">
                                    <h3 style={{ fontSize: 20, color: "white", letterSpacing: 7 }}>BANKING & FINANCE</h3>
                                </div>
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12" style={{ paddingRight: "50px" }}>
                            <div style={{ height: "80vh", border: "5px solid #D7D7D7", padding: "30px 10px" }}>
                                ...
                                <div class="d-flex justify-content-center">
                                    <p class="" style={{ color: "#9A9A9A", fontSize: 14, margin: "30px auto", textAlign: "center", width: "60%" }}>Enhance Return on Investment (ROI) & manage daily workflows with our result driven Java development services</p>
                                </div>
