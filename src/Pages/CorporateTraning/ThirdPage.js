...
import '../../Pages/CorporateTraning/ThirdPage.css'
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                        <div class="d-flex justify-content-around align-items-center">
                            <div class="text-center">
                                ...
                                <div>
                                    <span class="e-commerce" style={{fontSize:11, letterSpacing: 2 ,color:picture ? "black": "#9A9A9A",fontWeight:picture ? 700 : 600}}>CUSTOM DEVELOPMENT</span>
                                </div>
                            </div>
