...
import '../../Pages/JavaOutsourcing/FifthPageJava.css';
      ...
      <OwlCarousel options={options}>
        {details.map((item,index) => (
          <div key={item.id} class="owlCarousel" style={{display:"flex"}} >
            ...
            <h3 style={{color:"black",fontWeight:700}}>{item.title}</h3>
            ...
            <div className="View-button" style={{cursor:"pointer", border: "5px solid #000000", width: "fit-content", padding: "5px 5px", fontSize: 12, fontWeight: 700 ,color:"black"}}>VIEW CASE STUDY</div>
         </div>
        </div>
