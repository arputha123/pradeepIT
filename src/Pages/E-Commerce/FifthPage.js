...
import '../../Pages/E-Commerce/FifthPageECommerce.css';
      ...
      <OwlCarousel options={options}>
        {details.map((item,index) => (
          <div key={item.id} class="owlCarousel" style={{display:"flex"}} >
            ...
            <div className="View-button" style={{cursor:"pointer",color:"black" ,border: "5px solid #000000", width: "fit-content", padding: "5px 5px", fontSize: 12, fontWeight: 700 }}>VIEW CASE STUDY</div>
         </div>
        </div>
