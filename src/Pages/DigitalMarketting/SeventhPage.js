...
import "../../Pages/DigitalMarketting/Seven.css";
...
<div class="Start-Now fade-in "   style={{width:"fit-content",cursor:"pointer",padding:"20px 30px",border:"4px solid black",color:"black",fontSize:22,fontWeight:700}}>START NOW</div>
</div>
