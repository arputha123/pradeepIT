...
import '../../Pages/CMSPayment/FirstPage.css';
  ...
  return (
    <div className="video-container" ref={videoContainerRef} >
      ...
      <div className="text-content">
        <h1 class="heading">CMS WITH PAYMENT GATEWAY</h1>
        <p class="first-page">OUR INNOVATIVE CMS WITH PAYMENT GATEWAY SOLUTIONS FOR BUSINESS GROWTH</p>
      </div>
    </div>
  );
}
