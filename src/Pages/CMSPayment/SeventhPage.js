...
import "../../Pages/CMSPayment/Seven.css";
...
<div class="Start-Now fade-in"   style={{width:"fit-content",padding:"20px 30px",border:"4px solid black",color:"black",fontSize:22,fontWeight:700,cursor:"pointer"}}>START NOW</div>
</div>
