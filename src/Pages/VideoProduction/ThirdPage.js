...
import '../../Pages/VideoProduction/ThirdPage.css'
        ...
        <>
            <div style={{ width: "100%", height: "auto" }}>
                ...
                <div class="d-flex justify-content-center" style={{ marginBottom: 50 }}>
                    <h3 style={{ fontSize: "20px", fontWeight: 700, color: "#000000" }}>OUR SERVICES</h3>
                </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                        <div class="d-flex justify-content-around align-items-center">
                            <div class="text-center">
                                ...
                                <span class="e-commerce" style={{fontSize:11, letterSpacing: 2 ,color:picture ? "black": "#9A9A9A",fontWeight:picture ? 700 : 600}}>CORPORATE VIDEO</span>
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                        <div class="d-flex justify-content-around align-items-center">
                            <div class="text-center">
                                ...
                                <div>
                                    <span class="e-commerce" style={{fontSize:11, letterSpacing: 2,fontWeight:tool? 700 :  600,color: tool ?"black":"#9A9A9A" }}>PRODUCT VIDEO</span>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                        <div class="d-flex justify-content-around align-items-center">
                            <div class="text-center">
                                ...
                                <div>
                                    <span class="e-commerce" style={{fontSize:11, letterSpacing: 2 ,color:mobile?"black": "#9A9A9A",fontWeight:mobile ? 700 : 600}}>BRAND VIDEO</span>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                        <div class="d-flex justify-content-around align-items-center">
                            <div class="text-center">
                                ...
                                <div>
                                    <span class="e-commerce" style={{fontSize:11, letterSpacing: 2 ,color:camera?"black": "#9A9A9A" ,fontWeight:camera ? 700 : 600}}>TESTIMONIAL VIDEO</span>
                                </div>
                            </div>
                    ...
                    {picture && <>
                        <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 ">
                            <div style={{ height: "80vh", backgroundColor: "#666666", paddingTop: "350px", paddingBottom: "50px" }}>
                                ...
                                <div class="d-flex justify-content-center">
                                    <h3 style={{ fontSize: 20, color: "white", letterSpacing: 7 }}>CORPORATE VIDEO</h3>
                                </div>
                    ...
                    {camera && <>
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                            <div style={{ height: "80vh", backgroundColor: "#666666", paddingTop: "350px", paddingBottom: "50px" }}>
                                ...
                                <div class="d-flex justify-content-center">
                                    <h3 style={{ fontSize: 20, color: "white", letterSpacing: 7 }}>TESTIMONIAL VIDEO</h3>
                                </div>
                    ...
                    {tool && <>
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                            <div style={{ height: "80vh", backgroundColor: "#666666", paddingTop: "350px", paddingBottom: "50px" }}>
                                ...
                                <div class="d-flex justify-content-center">
                                    <h3 style={{ fontSize: 20, color: "white", letterSpacing: 7 }}>PRODUCT VIDEO</h3>
                                </div>
                    ...
                    {mobile && <>
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                            <div style={{ height: "80vh", backgroundColor: "#666666", paddingTop: "350px", paddingBottom: "50px" }}>
                                ...
                                <div class="d-flex justify-content-center">
                                    <h3 style={{ fontSize: 20, color: "white", letterSpacing: 7 }}>BRAND VIDEO</h3>
                                </div>
