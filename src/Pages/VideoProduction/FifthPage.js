...
import '../../Pages/VideoProduction/FifthPageVideo.css';
...
const CarouselComponent = () => {
  ...
  const optionsCarouselComponent = {
    items: 1, 
    nav: false, 
    dots: true, 
    loop: true, 
  ...
  return (
    <div className="custom-cursor" style={{cursor:"ew-resize", position: "relative", height: "auto", backgroundColor: "#F6F6F6", padding: "80px 0px"}}>
     <div class="d-flex justify-content-center" style={{paddingBottom:20}}>
     <h3 style={{fontSize:20,fontWeight:700,color:"black"}}>CASE STUDIES</h3>
     </div>
    
      <OwlCarousel options={optionsCarouselComponent}>
