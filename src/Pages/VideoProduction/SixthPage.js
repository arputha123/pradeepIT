...
import '../../Pages/VideoProduction/SixthVideo.css'
...
function SixthPage() {
    ...
    const optionsSixthPage = {
        items: 3,
        nav: false,
        dots: true,
        dotsClass: 'owl-dots',
        dotClass: 'owl-dot-sixth',
        dotsEach: 3,
        touchDrag: true,
        startPosition: 0,
        onTranslated: (event) => {
    ...
    return (
        <div style={{ cursor: "ew-resize", position: "relative", height: "auto", backgroundColor: "#000000", padding: "120px 0px" }}>
            ...
            <div class="d-flex justify-content-center">
                <div class="mt-5 mb-5" style={{ marginLeft: 0, marginRight: 0, height: 2, backgroundColor: "#e6af2a", width: 30 }}></div>
            </div>
            <OwlCarousel options={optionsSixthPage} style={{ marginTop: 40 }}>
